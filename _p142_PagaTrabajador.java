...
public class _p142_PagaTrabajador extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        _p142_PagaTrabajador app = new _p142_PagaTrabajador();
